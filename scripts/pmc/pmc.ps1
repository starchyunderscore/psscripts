...
Write-Output "`n!!!!!!!!!!`nWARNING: THIS SCRIPT IS UNTESTED`n!!!!!!!!!!`n"
$ContinueScript = $Host.UI.PromptForChoice("Are you sure you want to continue?", "", @("&No", "&Yes"), 0)
if ($ContinueScript -eq 0) {
